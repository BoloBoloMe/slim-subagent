...
基准: `opencode-go/deepseek-v4-flash` 除 multimodal 外全维 = 1 (该模型纯文本, multimodal 无比率锚点, 用绝对能力档: 1=可用, 1.5+=强). 其余模型分数为相对基准的比率分, 允许 >1 (强于基准) 或 <1.
...
|---|---|---|---|---|---|---|---|---|---|
| opencode-go/deepseek-v4-flash | 1 | 1 | 1 | null | 1 | derived | 1 | YYYY-MM-DD | 基准; 纯文本 |
